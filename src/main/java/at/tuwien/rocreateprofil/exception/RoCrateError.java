...
public enum RoCrateError {
    ...
    FILE_NOT_FOUND_ORUNACCESIBLE("File '%s' was either not found or is not accessible"),
    ...
    MALFORMED_RO_CRATE_METADATA_JSON("The ro-crate-metadata.json is not valid and cannot be parsed");


    RoCrateError(String message) {
